...
def create_deep_fm(inputs, feature_size , deep_layers=[256,128,64],dropout_keep_deep=[1,1,1,1],dropout_keep_fm=[1,1]):
    """
      Args:
...
all_df = pd.read_table(TRAINFILE,header=None,encoding='utf8',sep=',',skiprows=1,names=ids)
...
###design deepfm####
prediction=create_deep_fm(x,len(feature))
